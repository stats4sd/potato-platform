        ...
        <div class="container py-4" v-if="selected.length!=0">
            ...
            <div class="card">
                <h5 class="card-header bg-info">
                    <a data-toggle="collapse" style="color:white" href="#collapse-1" aria-expanded="true" aria-controls="collapse-1" id="heading-1" class="d-block">
             ...
             <div class="card">
                <h5 class="card-header bg-info">
                    <a data-toggle="collapse" style="color:white" href="#collapse-2" aria-expanded="true" aria-controls="collapse-2" id="heading-2" class="d-block">
                        <i class="fa fa-chevron-down pull-right"></i>
                        Fructificación
                    </a>
                </h5>
            ...
            <div class="card">
                <h5 class="card-header bg-info">
                    <a data-toggle="collapse" style="color:white" href="#collapse-3" aria-expanded="true" aria-controls="collapse-3" id="heading-3" class="d-block">
                        <i class="fa fa-chevron-down pull-right"></i>
            ...
            <div class="card">
                <h5 class="card-header  bg-info">
                    <a data-toggle="collapse" style="color:white" href="#collapse-4" aria-expanded="true" aria-controls="collapse-4" id="heading-4" class="d-block">
                        <i class="fa fa-chevron-down pull-right"></i>
                        Brotamiento
                    </a>
                </h5>
