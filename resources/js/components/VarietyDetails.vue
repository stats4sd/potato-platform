        ...
        <div class="card">
            ...
            >
                <div class="card-body">
                    ...
                    <div class="row">
                        <div
                            v-for="(photo, index) in floweringPhotos"
                            :key="index"
                            class="col-sm"
                        >
                            <img
        ...
        <div class="card">
            ...
            >
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm">
                            <p><strong>Color predominante:</strong> {{ tubersAtHarvest.color_predominant_tuber }}</p>
                            <p><strong>Intensidad del color predominante:</strong> {{ tubersAtHarvest.intensity_color_predominant_tuber }}</p>
                            <p><strong>Color secundario:</strong> {{ tubersAtHarvest.color_secondary_tuber }}</p>
                            <p><strong>Distribución del color secundario:</strong> {{ tubersAtHarvest.distribution_color_secodary_tuber }} </p>
                            <p><strong>Forma general:</strong> {{ tubersAtHarvest.shape_tuber }}</p>
                            <p><strong>Variante de forma:</strong> {{ tubersAtHarvest.variant_shape_tuber }}</p>
                            <p><strong>Profundidad de los ojos:</strong> {{ tubersAtHarvest.depth_tuber_eyes }} </p>
                            <p><strong>Color predominante de la pulpa:</strong> {{ tubersAtHarvest.color_predominant_tuber_pulp }}</p>
                            <p><strong>Color secundario:</strong> {{ tubersAtHarvest.color_secondary_tuber_pulp }}</p>
                            <p><strong>Distribución del color secundario:</strong> {{ tubersAtHarvest.distribution_color_secodary_tuber_pulp }} </p>
                            <p><strong>Nivel de tolerancia a la rancha:</strong> {{ tubersAtHarvest.level_tolerance_late_blight }}</p>
                            <p><strong>Nivel de tolerancia al gorgojo de los andes:</strong> {{ tubersAtHarvest.level_tolerance_weevil }}</p>
                            <p><strong>Nivel de tolerancia a la granizada:</strong> {{ tubersAtHarvest.level_tolerance_hailstorms }}</p>
                            <p><strong>Nivel de tolerancia a la helada:</strong> {{ tubersAtHarvest.level_tolerance_frost }}</p>
                            <p><strong>Nivel de tolerancia a la sequía:</strong> {{ tubersAtHarvest.level_tolerance_drought }} </p>
                        </div>
                        <div class="col-sm">
                            <img
                                :src="'storage/' +tubersAtHarvest.photo_tuber"
                                height="200"
                                fluid
                                alt="Photo Tuber"
                            ></img>
