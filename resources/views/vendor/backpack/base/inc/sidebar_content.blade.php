...
<li class='nav-item nav-dropdown'>
    ...
    <ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url("fructification/upload-photo") }}'> Fructificación</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('flowering/upload-photo') }}'> Floración</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('tubers_at_harvest/upload-photo') }}'> Tubérculos a la cosecha</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('sprout/upload-photo') }}'> Brotamiento</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('farmer/upload-photo') }}'> Agricultores</a></li>
    </ul>
</li>
...
<li class='nav-item nav-dropdown'>
    <a class='nav-link nav-dropdown-toggle' href="#">Sistemas de producción</a>
    <ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('productionsystem') }}'> Sistemas de producción</a></li>
